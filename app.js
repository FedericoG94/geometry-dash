...
function inputDown(){engine.inputDown()}function inputUp(){engine.inputUp();engine.release()}
...
ui.touchJump.addEventListener('pointerdown',e=>{e.preventDefault();e.stopPropagation();inputDown()},{passive:false});ui.touchJump.addEventListener('pointerup',inputUp,{passive:true});ui.touchPause.addEventListener('pointerdown',e=>{e.preventDefault();e.stopPropagation();pause()},{passive:false});
