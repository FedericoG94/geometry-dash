const CACHE='geometry-dash-v21';
const ASSETS=['./','./index.html','./styles.css?v=21','./app.js?v=21','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
