const CACHE='geometry-dash-v28';
const ASSETS=['./','./index.html','./styles.css?v=28','./app.js?v=28','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
