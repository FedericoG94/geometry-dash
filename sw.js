const CACHE='geometry-dash-v26';
const ASSETS=['./','./index.html','./styles.css?v=26','./app.js?v=26','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
