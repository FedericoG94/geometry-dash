const CACHE='geometry-dash-v22';
const ASSETS=['./','./index.html','./styles.css?v=22','./app.js?v=22','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
