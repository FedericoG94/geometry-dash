const CACHE='geometry-dash-v20';
const ASSETS=['./','./index.html','./styles.css?v=20','./app.js?v=20','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
