const CACHE='geometry-dash-v23';
const ASSETS=['./','./index.html','./styles.css?v=23','./app.js?v=23','./engine.js','./renderer.js','./levels.js','./storage.js','./editor.js','./manifest.webmanifest'];
