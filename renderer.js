const COLORS={bg1:'#06122a',bg2:'#12345a',grid:'rgba(90,220,255,.10)',ground:'#07101e',line:'#42e8ff',white:'#fff',cube:'#42e8ff',portal:'#34dfff',gravity:'#c86cff',speed:'#ff9d3d',mini:'#75ffdf',dual:'#ff5bd6',pad:'#ffe34d',ring:'#ffe34d'};
